...
# MAX_PATH  will be reached on Windows for several files and dirs generated by this script
        ...
        for dirs in data:
            ...
            if 'Not Passed' not in l:
                ...
                if 'Interview Prep' in l:
                    ...
                    switch = 1
                l = shorten_path(l)
                #if '\\\\?\\' not in pwd: does not work
                #    npwd = '\\\\?\\' + pwd + '\\' + l does not work
                #else:
                npwd = os.getcwd() + '\\' + l
                print(npwd)
                os.mkdir(npwd)
                ...
                if '*' in l:
                    l.replace('*', '')
                # Project Euler Problems have colons in name
                if ':' in l:
                    c_index = l.index(':')
                    l = l[:c_index]
                iterate_files(l)
